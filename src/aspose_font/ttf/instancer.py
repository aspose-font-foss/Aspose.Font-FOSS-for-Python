...
class TtfInstancer:
    ...
    def instantiate(
        ...
        *,
        ...
        new_tables = TtfTableSet(
            ...
            fvar=None,
            _raw={tag: data for tag, data in tables._raw.items() if tag not in _VARIABLE_TABLES_TO_DROP},
        )
    ...
    def _apply_instance_names(
        ...
        *,
        ...
        base_family = name_table.best_name(16) or name_table.best_name(1) or font.font_family or "Font"
        ...
        name_table.replace_name(1, legacy_family_name)
        name_table.replace_name(2, legacy_style_label)
        name_table.replace_name(4, full_name)
        name_table.replace_name(6, postscript_name)
        name_table.replace_name(16, typographic_family_name)
        name_table.replace_name(17, typographic_style_label)
        name_table.replace_name(21, typographic_family_name)
        name_table.replace_name(22, typographic_style_label)
        name_table.replace_name(25, typographic_family_name)

...
class NameTable:
        ...
        *,
        ...
        for i, record in enumerate(self.records):
            if (
                ...
                and record.platform_id == platform_id
                and record.encoding_id == encoding_id
                and record.language_id == language_id
            ):
                self.records[i] = NameRecord(
                    platform_id=record.platform_id,
                    encoding_id=record.encoding_id,
    ...
    def ensure_english_platform_names(self, name_id: int, value: str) -> None:
        self.ensure_name_record(
            name_id,
            value,
            platform_id=3,
            encoding_id=1,
    ...
    def to_bytes(self) -> bytes:
        ...
        for record in self.records:
            if record.platform_id == 3:
                ...
                blob = record.value.encode("mac_roman", errors="replace")
            else:

...
VARIABLE_PRESENTATION_SCHEMA_NAME = "aspose-font.variable-presentation"
VARIABLE_PRESENTATION_SCHEMA_VERSION = "1.0"
VARIABLE_PRESENTATION_SCHEMA_REVISION = 1
...
class TtfFont(Font):
    ...
    def variable_presentation(
        ...
        *,
        ...
        return {
            "schema_name": VARIABLE_PRESENTATION_SCHEMA_NAME,
            "schema_version": VARIABLE_PRESENTATION_SCHEMA_VERSION,
            "schema_revision": VARIABLE_PRESENTATION_SCHEMA_REVISION,

...
def send_task_completion_report(
    ...
    *,
    ...
    if not endpoint:
        raise ValueError("ASPOSE_FONT_TOKEN_REPORT_ENDPOINT must be configured before sending reports")
    if not token:
        raise ValueError("ASPOSE_FONT_TOKEN_REPORT_TOKEN must be configured before sending reports")
